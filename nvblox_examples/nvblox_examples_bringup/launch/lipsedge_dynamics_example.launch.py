...
def generate_launch_description():
    ...
    from_bag_arg = DeclareLaunchArgument(
        ...
        description='Whether to run from a bag or live LIPSedge data')
    ...
    # LIPSedge
    lipsedge_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([os.path.join(
            bringup_dir, 'launch', 'sensors', 'lipsedge.launch.py')]),
        launch_arguments={
    ...
    rviz_launch = IncludeLaunchDescription(
        ...
        launch_arguments={'config_name': 'lipsedge_dynamics_example.rviz',
